...
public final class TypeManager {
    ...
    final public boolean castNeverFails( Type src, Type dst ) {
    	...
    	// by xiaowei zhou, we let allocation sites to penetrate more assigns/field stores... when considering types, 20120317
//      return fh.canStoreType( src, dst );
        return fh.canStoreTypeDespiteCLs( src, dst );
    }
