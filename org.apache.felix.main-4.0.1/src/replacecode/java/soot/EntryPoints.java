...
//    private final void addMethod( List<SootMethod> set, String methodSig ) {
    private final void addMethod( List<SootMethod> set, String methodSig, Integer defCL ) {
    	// by xiaowei zhou, , 20111215
//        if( Scene.v().containsMethod( methodSig ) ) {
//            set.add( Scene.v().getMethod( methodSig ) );
//        }
        if( Scene.v().containsMethod( methodSig, defCL ) ) {
            set.add( Scene.v().getMethod( methodSig, defCL ) );
        }
    }
...
//    }
    public List<SootMethod> implicit() {
        List<SootMethod> ret = new ArrayList<SootMethod>();
        addMethod( ret, "<java.lang.System: void initializeSystemClass()>", ClassLoaders.appCLNum );
        addMethod( ret, "<java.lang.ThreadGroup: void <init>()>", ClassLoaders.appCLNum);
        //addMethod( ret, "<java.lang.ThreadGroup: void remove(java.lang.Thread)>");
        addMethod( ret, "<java.lang.Thread: void exit()>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.lang.ThreadGroup: void uncaughtException(java.lang.Thread,java.lang.Throwable)>", ClassLoaders.appCLNum);
        //addMethod( ret, "<java.lang.System: void loadLibrary(java.lang.String)>");
        addMethod( ret, "<java.lang.ClassLoader: void <init>()>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.lang.ClassLoader: java.lang.Class loadClassInternal(java.lang.String)>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.lang.ClassLoader: void checkPackageAccess(java.lang.Class,java.security.ProtectionDomain)>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.lang.ClassLoader: void addClass(java.lang.Class)>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.lang.ClassLoader: long findNative(java.lang.ClassLoader,java.lang.String)>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.security.PrivilegedActionException: void <init>(java.lang.Exception)>", ClassLoaders.appCLNum);
        //addMethod( ret, "<java.lang.ref.Finalizer: void register(java.lang.Object)>");
        addMethod( ret, "<java.lang.ref.Finalizer: void runFinalizer()>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.lang.Thread: void <init>(java.lang.ThreadGroup,java.lang.Runnable)>", ClassLoaders.appCLNum);
        addMethod( ret, "<java.lang.Thread: void <init>(java.lang.ThreadGroup,java.lang.String)>", ClassLoaders.appCLNum);
        return ret;
    }
