...
import cn.iscas.tcse.osgiclassloadanalyzer.AnalysisTrigger;
...
public class AutoProcessor
{
    ...
    **/
    ...
    // by xiaowei zhou, add a reference to framework object to help analyzing work, 20111104
    ...
    **/
    // by xiaowei zhou, add a 'felix' parameter, 20111104
    public static void process(Map configMap, BundleContext context, Felix felix)
    {
    	m_felix = felix;
    ...
    private static void processAutoDeploy(Map configMap, BundleContext context)
    {
        ...
        if (actionList.size() > 0)
        {
            ...
            // by xiaowei zhou, go to the analyzer, 20111104
            AnalysisTrigger analyzer = new AnalysisTrigger(m_felix, startBundleList);
