...
public class Main
{
    ...
    **/
    public static void main(String[] args) throws Exception
    {
    	...
    	// by xiaowei zhou, we do not need shutdown hook, 20120222
...
//        }
        ...
        try
        {
            ...
            // by xiaowei zhou, add 'felix' parameter, 20111104
            AutoProcessor.process(configProps, m_fwk.getBundleContext(), (Felix)m_fwk);
            
            // by xiaowei zhou, exit immediately after analysis, 20111030
...
//            while (event.getType() == FrameworkEvent.STOPPED_UPDATE);
			...
			// by xiaowei zhou, insert code to connect verifier, 20111030
            
//			Verifier verifier = new Verifier();
//			verifier.init();
//
//			verifier.findDupPackages((Felix) m_fwk);
//
//			verifier.verify();
//            
            // by xiaowei zhou, start the framework here, 20111030
            m_fwk.start();
    ...
    **/
    public static void loadSystemProperties()
    {
        ...
        else
        {
        	...
        	// by xiaowei zhou, , 20120527
//            int index = classpath.toLowerCase().indexOf("felix.jar");
            int index = classpath.toLowerCase().indexOf("clap.jar");
