...
public class SparkOptions
{
	...
	// by xiaowei zhou, whether to keep source code line number in PAG's edges, this variable is for fast accessing, 20120416
    private boolean line_number_in_pag;

    public SparkOptions( Map options ) {
        this.options = options;
        
    	// by xiaowei zhou, , 20120416
        this.line_number_in_pag = soot.PhaseOptions.getBoolean( options, "line_number_in_pag" );
    }
	...
	// by xiaowei zhou, , 20120416
    public boolean line_number_in_pag() {
    	return this.line_number_in_pag;
    }
