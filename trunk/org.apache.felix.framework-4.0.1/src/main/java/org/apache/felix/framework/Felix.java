...
public class Felix extends BundleImpl implements Framework
{
    ...
    // by xiaowei zhou, make the resolver not final, 20111104
//    private final StatefulResolver m_resolver;
    private StatefulResolver m_resolver;
    ...
    public void init() throws BundleException
    {
        ...
        try
        {
            if ((getState() == Bundle.INSTALLED) || (getState() == Bundle.RESOLVED))
            {
                ...
                // by xiaowei zhou, comment out, 20111104
//                try
//                {
//                    m_resolver.resolve(
...
// TODO: REFACTOR - Not clear why this is here. We should look at all of these steps more closely.
    ...
    **/
	// by xiaowei zhou, change to public, 20111215
    ...
    **/
     ...
     *         there are no installed bundles.
    **/
    // by xiaowei zhou, change to public, 20111030
    ...
    **/
    ...
    // by xiaowei zhou, , 20111104
    public void setCurrentResolver(StatefulResolver newResolver) {
    	m_resolver = newResolver;
    }
...
// TODO: LAZY - Not sure if this is the best way...
  ...
  //by xiaowei zhou, change to public, 20111104
    public void acquireBundleLock(BundleImpl bundle, int desiredStates)
    ...
    **/
  //by xiaowei zhou, change to public, 20111104
    public void releaseBundleLock(BundleImpl bundle)
    {
        synchronized (m_bundleLock)
        {
            // Unlock the bundle.
